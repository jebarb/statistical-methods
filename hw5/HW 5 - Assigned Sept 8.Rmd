---
title: 'Homework 5 - CS 1 Questions 7 and 8'
...
```{r, eval=TRUE}
UNCTotalScores = UNCGames$Total.Score
length(UNCTotalScores)
```
...
p = pt(t, 33)
p
#This was not a particularly high-scoring game as it was a lower-scoring game than average and only approximately 38% of games (theoretically) had lower scores
```
...
A. Make a variable called UNCScores by grabbing only the Team.Score column from the table `UNCGames' tat you made earlier. Go ahead and output UNCScores to check your work.
