...
```{r}
hist(X1, breaks=10, main="Math SAT", xlab="Score", col="grey", freq=FALSE)
hist(X2, breaks=10, main="Verbal SAT", xlab="Score", col="grey", freq=FALSE)
hist(X3, breaks=10, main="HS Math GPA", xlab="GPA", col="grey", freq=FALSE)
hist(X4, breaks=10, main="HS English GPA", xlab="GPA", col="grey", freq=FALSE)
